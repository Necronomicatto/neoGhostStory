...
export default class GameScene3 extends Phaser.Scene {
    ...
    preload() {
        this.load.image('sky', 'assets/textures/sky3.png');
        this.load.image('mountains', 'assets/textures/mountains.png');
        this.load.image('wall', 'assets/textures/wall&windows.png');
        this.load.image('columns', 'assets/textures/columns&flags.png');
        this.load.image('floor', 'assets/textures/floor.png');

        this.load.audio('bgMusic', 'assets/audio/soundtrack_castle.mp3');
        this.load.audio('hit', 'assets/audio/hit.mp3');


        this.load.spritesheet('enemyIdle', 'assets/textures/castleEnemyIdle1.png', {
            frameWidth: 128,
            frameHeight: 128
        });
        this.load.spritesheet('enemyIdle2', 'assets/textures/castleEnemyIdle2.png', { frameWidth: 128, frameHeight: 128 });
        this.load.spritesheet('enemyIdle3', 'assets/textures/castleEnemyIdle3.png', { frameWidth: 128, frameHeight: 128 });


        this.load.spritesheet('enemyDead', 'assets/textures/castleEnemyDead1.png', {
            frameWidth: 128,
            frameHeight: 128
        });
        this.load.spritesheet('enemyDead2', 'assets/textures/castleEnemyDead2.png', { frameWidth: 128, frameHeight: 128 });
        this.load.spritesheet('enemyDead3', 'assets/textures/castleEnemyDead3.png', { frameWidth: 128, frameHeight: 128 });
    ...
    create() {
        ...
        this.mountains = this.add.tileSprite(0, 0, 768, 640, 'mountains').setOrigin(0);
        this.wall = this.add.tileSprite(0, 0, 768, 640, 'wall').setOrigin(0);
        this.columns = this.add.tileSprite(0, 0, 768, 640, 'columns').setOrigin(0);
        this.floor = this.add.tileSprite(0, 0, 768, 640, 'floor').setOrigin(0);
        ...
        this.anims.create({
            key: 'enemyDead1',
            frames: this.anims.generateFrameNumbers('enemyDead', { start: 0, end: 5 }),
            frameRate: 6,
            repeat: 0
        });
        ...
        this.anims.create({
            key: 'enemyDead2',
            frames: this.anims.generateFrameNumbers('enemyDead2', { start: 0, end: 5 }),
            frameRate: 6,
            repeat: 0
        });
        ...
        this.anims.create({
            key: 'enemyDead3',
            frames: this.anims.generateFrameNumbers('enemyDead3', { start: 0, end: 5 }),
            frameRate: 6,
            repeat: 0
        });
    ...
    update() {
        ...
        this.mountains.tilePositionX += 0.7 * this.gameSpeed;
        this.wall.tilePositionX += 0.8 * this.gameSpeed;
        this.columns.tilePositionX += 0.9 * this.gameSpeed;
        this.floor.tilePositionX += 1.0 * this.gameSpeed;
